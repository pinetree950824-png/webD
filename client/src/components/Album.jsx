            ...
            <div className="modal-wrapper-layout" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-content glass-panel glass-panel-glow" style={{ width: '700px', margin: 0, padding: '2.2rem' }}>
                <div className="modal-header">
                  <h3 style={{ fontSize: '1.68rem', fontWeight: 800 }}>카드 상세 보기</h3>
                ...
                <div className="card-metadata-info" style={{ gap: '1.2rem' }}>
                  <h4 className="card-title-name glow-text-cyan" style={{ fontSize: '2.23rem' }}>{selectedCard.name}</h4>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem', fontSize: '1.28rem', color: 'var(--text-secondary)' }}>
                    <p>
                  ...
                  <p style={{ fontSize: '1.28rem', lineHeight: '1.6', color: 'var(--text-secondary)', background: 'rgba(0,0,0,0.3)', padding: '1.2rem', borderRadius: '8px', border: '1px solid var(--border-color)', minHeight: '80px', whiteSpace: 'pre-line' }}>
                    {selectedCard.description}
                  </p>

                  <div style={{ marginTop: '1.2rem', borderTop: '1px dashed var(--border-color)', paddingTop: '1.2rem' }}>
                    <p style={{ fontSize: '1.33rem', fontWeight: 700, color: 'var(--accent-gold)' }}>
                      ...
                      <div style={{ marginTop: '1rem' }}>
                        {!isSellingMode ? (
                          <button 
                            ...
                            style={{ width: '100%', fontSize: '1.33rem', padding: '0.8rem' }}
                            onClick={() => {
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.7rem', background: 'rgba(255,255,255,0.05)', padding: '1.2rem', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)' }}>
                            <label style={{ fontSize: '1.23rem', fontWeight: 600 }}>판매 가격 설정 (Gold)</label>
                            <div style={{ display: 'flex', gap: '0.7rem' }}>
                              <input 
                                ...
                                style={{ flexGrow: 1, padding: '0.6rem', fontSize: '1.28rem' }}
                              />
                              <button 
                                className="btn btn-cyan" 
                                onClick={() => handleRegisterSale(availableIds[0], selectedCard.name)}
                                style={{ padding: '0.6rem 1.2rem', fontSize: '1.28rem' }}
                              >
                                등록
                              </button>
                              <button 
                            ...
                            {sellingError && <p style={{ color: 'var(--accent-red)', fontSize: '1.18rem', marginTop: '0.3rem' }}>{sellingError}</p>}
                          </div>
                        )}
                      </div>
                    ) : (
                      <p style={{ fontSize: '1.18rem', color: 'var(--text-muted)', marginTop: '0.7rem', fontStyle: 'italic' }}>
