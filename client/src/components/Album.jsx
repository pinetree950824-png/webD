            ...
            <div className="modal-wrapper-layout" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-content glass-panel glass-panel-glow" style={{ width: '480px', margin: 0, padding: '2.2rem' }}>
                ...
                <div className="card-metadata-info" style={{ gap: '1.2rem' }}>
                  <h4 className="card-title-name glow-text-cyan" style={{ fontSize: '2.35rem' }}>{selectedCard.name}</h4>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem', fontSize: '1.4rem', color: 'var(--text-secondary)' }}>
                    <p>
                  ...
                  <p style={{ fontSize: '1.4rem', lineHeight: '1.6', color: 'var(--text-secondary)', background: 'rgba(0,0,0,0.3)', padding: '1.2rem', borderRadius: '8px', border: '1px solid var(--border-color)', minHeight: '80px', whiteSpace: 'pre-line' }}>
                    {selectedCard.description}
                  </p>

                  <div style={{ marginTop: '1.2rem', borderTop: '1px dashed var(--border-color)', paddingTop: '1.2rem' }}>
                    <p style={{ fontSize: '1.45rem', fontWeight: 700, color: 'var(--accent-gold)' }}>
                      ...
                      <div style={{ marginTop: '1rem' }}>
                        {!isSellingMode ? (
                          <button 
                            ...
                            style={{ width: '100%', fontSize: '1.45rem', padding: '0.8rem' }}
                            onClick={() => {
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.7rem', background: 'rgba(255,255,255,0.05)', padding: '1.2rem', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)' }}>
                            <label style={{ fontSize: '1.35rem', fontWeight: 600 }}>판매 가격 설정 (Gold)</label>
                            <div style={{ display: 'flex', gap: '0.7rem' }}>
                              <input 
                                ...
                                style={{ flexGrow: 1, padding: '0.6rem', fontSize: '1.4rem' }}
                              />
                              <button 
                                className="btn btn-cyan" 
                                onClick={() => handleRegisterSale(availableIds[0], selectedCard.name)}
                                style={{ padding: '0.6rem 1.2rem', fontSize: '1.4rem' }}
                              >
                                등록
                              </button>
                              <button 
                            ...
                            {sellingError && <p style={{ color: 'var(--accent-red)', fontSize: '1.3rem', marginTop: '0.3rem' }}>{sellingError}</p>}
                          </div>
                        )}
                      </div>
                    ) : (
                      <p style={{ fontSize: '1.3rem', color: 'var(--text-muted)', marginTop: '0.7rem', fontStyle: 'italic' }}>
